...
(defproblem-multi log-ran-20-1 logistics
   (
        (AIRPLANE plane1)
...
;;--------------------------------------
(defproblem-multi log-ran-20-2 logistics
   (
        (AIRPLANE plane1)
...
;;--------------------------------------
(defproblem-multi log-ran-20-3 logistics
   (
        (AIRPLANE plane1)
...
;;--------------------------------------
(defproblem-multi log-ran-20-4 logistics
   (
        (AIRPLANE plane1)
        (airplane-at plane1 LOC10-1)
        (AIRPLANE plane2)
...
;;--------------------------------------
(defproblem-multi log-ran-20-5 logistics
   (
        (AIRPLANE plane1)
...
;;--------------------------------------
(defproblem-multi log-ran-20-6 logistics
   (
        (AIRPLANE plane1)
...
;;--------------------------------------
(defproblem-multi log-ran-20-7 logistics
   (
        (AIRPLANE plane1)
...
;;--------------------------------------
(defproblem-multi log-ran-20-8 logistics
   (
        (AIRPLANE plane1)
...
;;--------------------------------------
(defproblem-multi log-ran-20-9 logistics
   (
        (AIRPLANE plane1)
        (airplane-at plane1 LOC4-1)
        (AIRPLANE plane2)
...
;;--------------------------------------
(defproblem-multi log-ran-20-10 logistics
   (
        (AIRPLANE plane1)
        (airplane-at plane1 LOC9-1)
        (AIRPLANE plane2)
